...
export function MoviesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MoviesResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(MovieFromJSON)),
...
export function MoviesResponseToJSON(value?: MoviesResponse | null): any {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(MovieToJSON)),
        'total': value.total,
        'offset': value.offset,
        'limit': value.limit,
    };
