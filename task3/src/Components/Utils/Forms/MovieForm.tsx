...
import {Formik, Form, Field, FormikHelpers, FormikValues, FormikProps} from "formik";
                  ...
                  <Form>
                    <div className="columns">
                      <div className="column">
                        ...
                        {errors.title && touched.title ? <span className="has-text-danger">{errors.title}</span> : null}
                      </div>
                      <div className="column">
                        <label htmlFor="releaseDate">Release Date</label>
                        <Field id="releaseDate" name="releaseDate"  type="date" placeholder="Release Date" />
                      </div>
                    </div>
                    ...
                    <div className="columns">
                      <div className="column">
                        ...
                        <Field id="posterPath" name="posterPath" type="text" placeholder="Poster" />
                        {errors.posterPath && touched.posterPath ? <span className="has-text-danger">{errors.posterPath}</span> : null}
                      </div>
                      <div className="column">
                        <label htmlFor="voteCount">Vote Count</label>
                        <Field id="voteCount" name="voteCount"  type="number" placeholder="Vote Count" />
                      </div>
                    </div>
                    ...
                    <div className="columns">
                      <div className="column">
                        ...
                        {errors.genres && touched.genres ? <span className="has-text-danger">{errors.genres}</span> : null}
                      </div>
                      <div className="column">
                        <label htmlFor="runtime">Runtime</label>
                        <Field id="runtime" name="runtime" type="number" placeholder="Runtime" />
                        {errors.runtime && touched.runtime ? <span className="has-text-danger">{errors.runtime}</span> : null}
                      </div>
                    </div>

                    <div className="columns">
                      <Field id="overview" name="overview" placeholder="Overview"
                        component="textarea"  cols={100} rows={6}>
                      </Field>
                      {errors.overview && touched.overview ? <span className="has-text-danger">{errors.overview}</span> : null}
                    </div>
                  </Form>
              )
            }
